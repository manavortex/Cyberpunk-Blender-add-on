...
def rename_color_attribtue(mesh, name_before, name_after):
...
def manage_garment_support(existingMeshes, gltf_importer_data):
    ...
    for name in bpy.data.meshes.keys():
        ...
        rename_color_attribtue(mesh, "_GARMENTSUPPORTCAP", "GarmentSupportCap")
        rename_color_attribtue(mesh, "_GARMENTSUPPORTWEIGHT", "GarmentSupportWeight")
